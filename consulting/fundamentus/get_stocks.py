...
def get_stock(param):
    ...
    if _type == "<class 'list'>":
        logging.info('details: call: get..._list()')
        return get_datails_list(param)
    else:
        logging.info('details: call: get..._papel()')
        return get_datails_stock(param)


def get_datails_list(lst):
    """
...
def get_datails_raw(papel='WEGE3'):
    """
