...
def get_fii(param):
    ...
    Get detailed data from fundamentus:
      URL:
        http://fundamentus.com.br/detalhes.php?papel=HGLG11
    ...
    if _type == "<class 'list'>":
        ...
        return get_details_fiis_list(param)
    else:
        logging.info('detalhes: call: get..._fii()')
        return get_datails_fii(param)


def get_details_fiis_list(lst):
    """
...
def get_datails_fii(fii):
    ...
    tables = get_datails_fii_raw(fii)
...
def get_datails_fii_raw(fii='HGLG11'):
    """
